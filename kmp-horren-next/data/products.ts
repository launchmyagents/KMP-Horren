...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    maxHeightMm: 2000,
    description:
      "Wordt op het kozijn geplaatst, met hetzelfde geplisseerde harmonicagaas als onze Inzet Plissé Hor. Ideaal bij onvoldoende inbouwdiepte.",
    features: [
      "Montage op kozijn",
      "Geplisseerd harmonicagaas",
