...
/**
 * Cross-links between individual product pages, per the interne-linkstructuur
 * plan in clients/kmp-horren/content/onpage-productpaginas.md. Kept separate
 * from PRODUCT_SEO so a slug can appear with 0, 1 or 2 related links without
 * affecting the title/description/h1 shape above.
 */
...
export const RELATED_PRODUCTS: Record<string, RelatedProductLink[]> = {
  "luxe-inzethor": [
    ...
    {
      slug: "luxe-rolhor",
      anchor: "Verwante raamhor: bekijk de luxe rolhor",
    },
  ],
  "inzet-plisse-hor": [
    {
  ...
  "luxe-rolhor": [
    {
      slug: "luxe-inzethor",
      anchor: "Verwante raamhor: bekijk de luxe inzethor",
    },
  ],
  "plisse-hordeur-enkel": [
    {
      slug: "plisse-hordeur-dubbel",
      anchor: "Brede doorgang? Bekijk de dubbele plissé hordeur",
    },
  ],
  "plisse-hordeur-dubbel": [
    {
